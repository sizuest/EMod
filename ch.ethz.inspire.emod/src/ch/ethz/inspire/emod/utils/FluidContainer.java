...
public class FluidContainer extends IOContainer {
	...
	public FluidContainer(String name, SiUnit unit, ContainerType type,
			FluidCircuitProperties fluidCircuitProperties) {
	 ...
	 * @param fluidCircuitProperties
	 */
	public FluidContainer(String name, FluidContainer reference,
			FluidCircuitProperties fluidCircuitProperties) {
	...
	/**
	 * Override the setValue method from IOContainer This method gets called
	 * when updating the Machine IOConnection-List --> see
	 * EmodSimulationMain.setInputs()
	 * 
	 * @param value
	 * @deprecated use FluidConnection.update(). Formerly used in
	 *             EModSimulationMain.setInputs(), changed to
	 *             Connection.update()
	 */
	@Deprecated
	@Override
	public void setValue(double value) {
		System.err
				.println("FluidContainer: setValue(...) called: This must not happen!");
	}
