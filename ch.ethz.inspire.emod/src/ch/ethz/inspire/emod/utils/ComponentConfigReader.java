 ...
 * 
 */
public class ComponentConfigReader extends ConfigReader {
	 ...
	 *             occurs.
	 */
	public ComponentConfigReader(String component, String type)
			throws Exception {
		/*
		...
		filePath = path_prefix + "/" + component + "/" + component + "_" + type
				+ ".xml";
