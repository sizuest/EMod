...
public class FluidConnection extends IOConnection {
	 ...
	 * "FluidOut", target has to have input "FluidIn"
	 * 
	 * @param source
	 * @param target
	 * @throws Exception
	 */
	public FluidConnection(APhysicalComponent source, APhysicalComponent target)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public FluidConnection(FluidContainer source, FluidContainer target)
			throws Exception {
		super(source, target);
	...
	/**
	 * update from source to target or vice versa according to the direction of
	 * calculation
	 */
	@Override
	public void update() {
