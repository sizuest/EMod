...
public class MotorTest {
	...
	public void testLinearMotor() {
		...
		// Set rotational speed [Hz]
		lm.getInput("RotSpeed").setValue(1500/60);
		// Set torque [Nm]
		...
		lm.getInput("RotSpeed").setValue(2250/60);
		// Set torque [Nm]
		lm.getInput("Torque").setValue(2);
		// update outputs
		lm.update();
		assertEquals("Pmech", 465, lm.getOutput("PUse").getValue(), 1);
		assertEquals("Ploss", 1287, lm.getOutput("PLoss").getValue(), 1);	
