...
public class PumpFluidTest {
	...
	public void testPump(){
		...
		assertEquals("Flow if on",           /*3.6*/1.44, ((FluidContainer)pump.getInput("FluidIn")).getFlowRate(),  0);
		assertEquals("Pressure if on",   2000000, ((FluidContainer)pump.getOutput("FluidOut")).getPressure(),    1);
	}
}
