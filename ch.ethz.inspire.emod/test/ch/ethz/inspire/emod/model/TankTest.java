...
public class TankTest {
	...
	public void testTank(){
		...
		Tank tank1 = new Tank("Schaublin42L");
		...
		((FluidContainer)tank1.getInput("FluidIn")).  setValues(293, 1, 0.00014);
		((FluidContainer)tank1.getOutput("FluidOut")).setValues(293, 1, 0.00014);
	...
	public void testTank2(){
		...
		((FluidContainer)tank.getInput("FluidIn")).setValues(304, 100000, 0.00014);
		((FluidContainer)tank.getOutput("FluidOut")).setValues(303, 100000, 0.00014);
