...
public class GeometricKienzleSimulationControlTest {
	...
	public void before() {
		...
		try {
			tester = new GeometricKienzleSimulationControl("test", "test/ch/ethz/inspire/emod/simulation/GeometricSimulationControl_tester.txt", n, f, ap, d);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void testReadSamplesFromFile() {
		try {
			tester.readSamplesFromFile("test/ch/ethz/inspire/emod/simulation/GeometricSimulationControl_samplestester.txt");
		} catch (Exception e) {
			e.printStackTrace();
		}
